...
public class PostServiceImpl implements PostService {
    ...
    public Page<PostResponse> getPostList(PostSearchRequest request) {
        ...
        java.util.List<PostResponse> records = postPage.getRecords().stream()
    ...
    public void adminDeletePost(Long postId) {
        ...
        log.info("管理员删除帖子: postId={}, authorId={}", postId, post.getAuthorId());
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public void batchDeletePosts(java.util.List<Long> postIds) {
    ...
    @Override
    public Page<PostResponse> getUserPosts(Long userId, Integer pageNum, Integer pageSize) {
